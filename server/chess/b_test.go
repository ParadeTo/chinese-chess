...
func TestB_CanMove(t *testing.T) {
	testData := []TestDataCanMove{
		...
		{
			pieces: []*Piece{
				NewB("b", [2]int{3, 2}, Top, ""),
				NewZ("r", [2]int{3, 1}, Top, ""),
			},
			pos:      [2]int{3, 1},
			expected: true,
		},
