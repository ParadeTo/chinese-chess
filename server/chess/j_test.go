...
func TestJ_CanMove(t *testing.T) {
	testData := []TestDataCanMove{
		...
		{
			pieces: []*Piece{
				NewJ(Red, [2]int{0, 9}, Bottom, ""),
				NewZ(Black, [2]int{0, 3}, Bottom, ""),
			},
			pos:      [2]int{0, 0},
			expected: false,
		},
		{
			pieces: []*Piece{
				NewJ(Red, [2]int{8, 0}, Bottom, ""),
				NewZ(Black, [2]int{0, 0}, Bottom, ""),
			},
			pos:      [2]int{0, 0},
			expected: true,
		},
